...
{	
	Cola cola;
	HashTable hashtable = inicializarHashTable(1000,&imprimir,&comparar);
	...
	int i;
	for( i = 0 ; i < 100; i++)
		insertarClave(&hashtable, &alumnos[i]);
	
	imprimirHashTabla(&hashtable);
	Alumno alumno = {0,"Edgar",""};
	printf("\n BUSCAR EDGAR ");	
...
Alumno* obtenerDatos(void)
{
	static Alumno alumnos[100] = {
		...
		{1229959, "Fernando", "Díaz"},
		{1229960, "Isabel", "Herrera"},
		{1229961, "Miguel", "Ruiz"},
		{1229962, "Lucia", "Flores"},
		{1229963, "Javier", "García"},
		{1229964, "Andrea", "Soto"},
		...
		{1230005, "Ivan", "Díaz"}, // Apellido repetido
		{1230006, "Tamara", "Herrera"}, // Apellido repetido
		{1230007, "Benjamín", "Ruiz"}, // Apellido repetido

		// 70 Alumnos
		{1230008, "Paola", "Flores"}, // Apellido repetido
		{1230009, "Arturo", "García"}, // Apellido repetido
		{1230010, "Regina", "Soto"}, // Apellido repetido
		{1230011, "Héctor", "Vargas"}, // Apellido repetido
		{1230012, "Alejandro", "Reyes"}, // Nombre repetido, apellido repetido
		{1230013, "Verónica", "Mendoza"}, // Apellido repetido
		...
		// 90 Alumnos
		{1230028, "Pedro", "Díaz"}, // Nombre repetido, apellido repetido
		...
		{1230032, "Roberto", "García"}, // Nombre repetido, apellido repetido
